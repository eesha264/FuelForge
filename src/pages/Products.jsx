...
const DEMO_PRODUCTS = [
    ...
    { _id: '9', name: 'Pre-Workout Powder', price: 39.99, category: 'Protein & Supplements', rating: 4.6, numReviews: 201, countInStock: 40, image: 'https://placehold.co/400x400/065f46/ffffff?text=Pre-Workout' },
    { _id: '10', name: 'Jump Rope Speed Pro', price: 12.99, category: 'Accessories', rating: 4.1, numReviews: 67, countInStock: 150, image: 'https://placehold.co/400x400/064e3b/ffffff?text=Jump+Rope' },
    { _id: '11', name: 'Yoga Block Set (2)', price: 16.99, category: 'Yoga & Flexibility', rating: 4.4, numReviews: 102, countInStock: 90, image: 'https://placehold.co/400x400/10b981/ffffff?text=Yoga+Blocks' },
    { _id: '12', name: 'Kettlebell 20kg', price: 59.99, category: 'Gym Equipment', rating: 4.7, numReviews: 88, countInStock: 25, image: 'https://placehold.co/400x400/34d399/ffffff?text=Kettlebell' },
]
...
export default function Products() {
    ...
    // Client-side filter/sort for demo products
        ...
        <div className="min-h-screen bg-dark-50">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 mb-8">
                    ...
                    <form onSubmit={handleSearchSubmit} className="w-full md:w-auto">
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full md:w-80 pl-10 pr-4 py-2.5 bg-white border border-dark-200 rounded-xl text-sm focus:outline-none focus:border-primary-500 focus:ring-1 focus:ring-primary-500/30 transition-all"
                            />
                            {search && (
                                <button
                                    type="button"
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <select
                            ...
                            className="px-4 py-2.5 bg-white border border-dark-200 rounded-xl text-sm focus:outline-none focus:border-primary-500 transition-all cursor-pointer"
                        >
                        ...
                        <button
                            ...
                            className="lg:hidden flex items-center gap-2 px-4 py-2.5 bg-white border border-dark-200 rounded-xl text-sm hover:bg-dark-50 transition-colors"
                        >
                ...
                <div className="flex gap-8">
                    ...
                    >
                        <div className="bg-white border border-dark-100 rounded-2xl p-5 sticky top-24">
                            <h3 className="text-sm font-semibold text-dark-900 mb-4 uppercase tracking-wider">
                                Categories
                            </h3>
                            <div className="space-y-1.5">
                                {ALL_CATEGORIES.map((cat) => (
                                    <button
                                        ...
                                        className={`block w-full text-left px-3 py-2 text-sm rounded-lg transition-colors ${category === cat
                            ...
                            <div className="mt-6 pt-6 border-t border-dark-100">
                                ...
                                <div className="flex items-center gap-2">
                                    <input
                                        ...
                                        className="w-full px-3 py-2 border border-dark-200 rounded-lg text-sm focus:outline-none focus:border-primary-500"
                                        placeholder="Min"
                                        min={0}
                                    />
                    ...
                    <div className="flex-1">
                        {loading ? (
                            ...
                            <div className="text-center py-20">
                                <p className="text-dark-400 text-lg mb-2">No products found</p>
                                ...
                                {totalPages > 1 && (
                                    <div className="flex items-center justify-center gap-2 mt-10">
                                        <button
                                            ...
                                            disabled={page === 1}
                                            className="p-2 bg-white border border-dark-200 rounded-lg disabled:opacity-40 hover:bg-dark-50 transition-colors"
                                        >
